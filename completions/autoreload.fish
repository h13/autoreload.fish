complete -c autoreload -f
complete -c autoreload -n __fish_use_subcommand -a status -d "Show tracked files and configuration"
complete -c autoreload -n __fish_use_subcommand -a version -d "Print version number"
